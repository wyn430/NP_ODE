...
class MLP_Linear(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, bias=True, w_init='relu'):
        ...
        self.linear_layer = nn.Linear(in_dim, out_dim, bias=bias)
        self.linear_layer1 = nn.Linear(out_dim, out_dim, bias=bias)
        self.linear_layer2 = nn.Linear(out_dim, out_dim, bias=bias)
...
class MLP_Linear_De(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, bias=True, w_init='relu'):
        ...
        :param w_init: str. weight inits with xavier initialization.
        """
        super(MLP_Linear_De, self).__init__()
        self.linear_layer = nn.Linear(in_dim, int(in_dim/3), bias=bias)
        self.linear_layer1 = nn.Linear(int(in_dim/3), int(in_dim/3), bias=bias)
        self.linear_layer2 = nn.Linear(int(in_dim/3), out_dim, bias=bias)
...
class LatentEncoder(nn.Module):
    ...
    def __init__(self, num_hidden, num_latent, input_dim):
        ...
        self.input_projection = Linear(input_dim, num_hidden, w_init='relu')
...
class Decoder(nn.Module):
    ...
    def __init__(self, num_hidden, input_dim, y_dim):
        ...
        self.func = ConvODEF(num_hidden)
        self.DecoderODE = NeuralODE(self.func)
